...
var _isObjectLike = __webpack_require__(16);
...
var deposit5 = document.getElementById("deposit5");
...
//Action Creators
var depositMoney = function depositMoney(amount) {
  return {
    type: 'deposit',
    amount: amount
  };
};
var withdrawMoney = function withdrawMoney(amount) {
  return {
    type: 'withdraw',
    amount: amount
  };
...
deposit5.onclick = function () {
  return store.dispatch(depositMoney(5));
};
deposit25.onclick = function () {
  return store.dispatch(depositMoney(25));
};
withdraw5.onclick = function () {
  return store.dispatch(withdrawMoney(5));
};
...
var _getRawTag = __webpack_require__(12);

var _getRawTag2 = _interopRequireDefault(_getRawTag);

var _objectToString = __webpack_require__(13);
...
var _freeGlobal = __webpack_require__(11);
...
var _overArg = __webpack_require__(15);
